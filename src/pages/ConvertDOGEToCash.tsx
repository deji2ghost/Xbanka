...
import { BtcToCashUseCase, DOGEToCashFAQData } from "@/lib/data"

const ConvertDOGEToCash = () => {
  return (
    <div>
      ...
      />
      <FaqLayout
        header="FAQs About Dogecoin Exchange To Cash"
        data={DOGEToCashFAQData}
      />
    </div>
  )
}

export default ConvertDOGEToCash
