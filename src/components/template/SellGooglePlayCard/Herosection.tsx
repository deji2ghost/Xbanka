    ...
    >
      ...
      >
        ...
        <p className="mb-[48px] font-[600] text-[16px] leading-[24px] md:text-[24px] text-offWhite md:leading-[33.6px]">
          A Google Play gift card is primarily used to purchase digital content on Google Play. The best way to get the most value is to exchange the Google Play gift card for cash.
        </p>
