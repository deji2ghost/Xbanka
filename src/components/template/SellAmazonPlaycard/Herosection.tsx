    ...
    >
      ...
      >
        ...
        <p className="mb-[48px] font-[600] text-[16px] leading-[24px] md:text-[24px] text-offWhite md:leading-[33.6px]">
         The popularity of the Amazon store directly influences why the Amazon gift card is one of the most requested gift cards worldwide. You can easily convert Amazon gift cards with Xbanka and receive your funds quickly.
        </p>
