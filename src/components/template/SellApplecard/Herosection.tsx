    ...
    >
      ...
      >
        ...
        <p className="mb-[48px] font-[600] text-[16px] leading-[24px] md:text-[24px] text-offWhite md:leading-[33.6px]">
         If you're a tech enthusiast, an Apple gift card should be at the top of your list. It makes purchasing products and services from Apple incredibly convenient. Trade your Apple gift card with Xbanka and have a chance to win big!
        </p>
