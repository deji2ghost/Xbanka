    ...
    >
      ...
      >
        ...
        <p className="mb-[48px] font-[600] text-[16px] leading-[24px] md:text-[24px] text-offWhite md:leading-[33.6px]">
         eBay gift cards provide access to all items available on the eBay platform. They are among the most popular gift cards worldwide. You can convert your eBay gift card to cash using Xbanka.
        </p>
