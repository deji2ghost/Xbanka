    ...
    >
      ...
      >
        ...
        <p className="mb-[32px] text-center md:px-[40px] font-[400] text-[16px] leading-[24px] md:text-[24px] md:leading-[31.2px]">
          Steam gift cards are one of the most popular gift cards you can find in Nigeria. Xbanka  allows you to convert Steam cards to cash instantly. Get started today.
        </p>
