...
const HeroSection = () => {
  return (
    <div
      className="relative overflow-hidden bg-no-repeat px-4 pt-8 pb-[100px] md:pt-[196px] md:pb-[241px] bg-cover bg-center"
      style={{
    ...
    >
      ...
      className="md:w-[888px] flex flex-col text-center items-center justify-center mx-auto text-offWhite">
        <h1 className="mb-[24px] text-[32px] md:text-[64px] leading-[40px] font-[400] text-offWhite md:leading-[76.8px]">
