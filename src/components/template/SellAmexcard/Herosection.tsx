    ...
    >
      ...
      >
        ...
        <p className="mb-[48px] font-[600] text-[16px] leading-[24px] md:text-[24px] text-offWhite md:leading-[33.6px]">
         Amex gift cards hold great value and top rates in Nigeria. With Xbanka, you can easily exchange your Amex gift card for cash at the best rates and enjoy fast, secure payouts every time.
        </p>
